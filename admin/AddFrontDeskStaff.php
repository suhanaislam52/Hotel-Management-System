<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO frontdeskstaff (first_name, last_name, Phone_number, Gender, Address, Salary, In_Charge_of) 
                VALUES (?, ?, ?, ?, ?, ?, ?)";
        $values = array($first_name, $last_name, $phone_number, $gender, $address, $salary, $in_charge_of);
        $datatypes = "ssssdss"; 
...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to bottom, #fc03df, #fc03df);
        }
        form {
            margin: 0 auto;
            width: 50%;
